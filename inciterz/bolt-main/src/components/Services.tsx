  ...
  const services = [
    {
      ...
      description: 'Custom software development and digital product design tailored to your business needs.',
      color: '#002fa6'
    },
    {
      icon: TrendingUp,
      title: 'Strategy Consulting',
      description: 'Expert guidance on digital transformation, technology adoption, and business strategy.',
      color: '#002fa6'
    },
    {
      icon: Megaphone,
      title: 'Content Marketing',
      description: 'Engaging content creation and distribution strategies to amplify your brand voice.',
      color: '#002fa6'
    },
    {
      icon: Search,
      title: 'SEO Services',
      description: 'Comprehensive search engine optimization to boost your online visibility and rankings.',
      color: '#002fa6'
    },
    {
      icon: Target,
      title: 'Paid Advertising',
      description: 'Strategic PPC campaigns and paid media management for maximum ROI.',
      color: '#002fa6'
    },
    {
      icon: BarChart,
